...
Build the **finalform** semantic processing engine that transforms canonical JSON input into **immutable MeasurementEvent objects** with full provenance, scoring, and interpretation.
